...
@Index("migration_bill_item_sap_verify_bill_close_IDX", ["billClose"], {})
@Entity("migration_bill_item_sap_verify", { schema: "ecloud_rick" })
export class MigrationBillItemSapVerify {
