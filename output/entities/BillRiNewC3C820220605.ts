...
@Entity("bill_ri_new_C3C820220605", { schema: "ecloud_rick" })
export class BillRiNewC3C820220605 {
  @PrimaryGeneratedColumn({ type: "int", name: "id" })
  id: number;

  @Column("varchar", { name: "bill_period", length: 8 })
  billPeriod: string;
  ...
  @Column("varchar", { name: "platform", nullable: true, length: 100 })
  ...
  @Column("int", { name: "Purchased_Hours" })
  purchasedHours: number;

  @Column("int", { name: "Unused_Hours" })
  unusedHours: number;
  ...
  @Column("int", { name: "Total_Actual_Hours" })
