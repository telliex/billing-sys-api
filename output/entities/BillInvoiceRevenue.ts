...
@Index("ix_bill_inv_period_customer", ["billPeriod", "billCustomer"], {})
@Entity("bill_invoice_revenue", { schema: "ecloud_rick" })
export class BillInvoiceRevenue {
  ...
  @Column("varchar", { name: "cname", nullable: true, length: 200 })
  cname: string | null;
  ...
  @Column("decimal", {
    name: "cb_fee",
    comment: "Consolidate Billing Fee",
    precision: 8,
    scale: 2,
  })
  cbFee: string;
