...
@Index("migration_bill_item_sap_cost_bill_close_IDX", ["billClose"], {})
@Entity("migration_bill_item_sap_cost", { schema: "ecloud_rick" })
export class MigrationBillItemSapCost {
  ...
  overShortPriceRealcost: string | null;
}
