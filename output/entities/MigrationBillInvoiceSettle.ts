...
@Index("migration_bill_invoice_settle_bill_close_IDX", ["billClose"], {})
@Index(
  "customer_period_settledate",
  ["billCustomer", "billPeriod", "settleDate"],
  {}
)
@Entity("migration_bill_invoice_settle", { schema: "ecloud_rick" })
export class MigrationBillInvoiceSettle {
