...
@Entity("bill_customer_log", { schema: "ecloud_rick" })
export class BillCustomerLog {
  @Column("int", { name: "id" })
  id: number;
  ...
  @Column("tinyint", { name: "ava_rpt" })
  avaRpt: number;

  @Column("tinyint", { name: "inv_rpt" })
  invRpt: number;

  @Column("tinyint", { name: "per_rpt" })
  perRpt: number;

  @Column("tinyint", { name: "sec_rpt" })
  secRpt: number;
  ...
  @Column("int", { name: "industry_catalog", nullable: true })
  industryCatalog: number | null;
}
