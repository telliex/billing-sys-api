...
@Index("migration_rdr1_bill_close_IDX", ["billClose"], {})
@Index("migration_rdr1_leadger_country_IDX", ["leadgerCountry"], {})
@Entity("migration_rdr1", { schema: "ecloud_rick" })
export class MigrationRdr1 {
