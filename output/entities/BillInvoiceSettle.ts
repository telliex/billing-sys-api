...
@Index("ix_bill_invoice_settle_bill_period", ["billPeriod"], {})
@Entity("bill_invoice_settle", { schema: "ecloud_rick" })
export class BillInvoiceSettle {
  ...
  @Column("varchar", { name: "serial_no", length: 12 })
  serialNo: string;
